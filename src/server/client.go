...
func (c *Client) readPump(cc blockchain.ChainCodeInterface) {
	defer func() {
		c.hub.unregister <- c
		c.conn.Close()
	}()
...
func serveWs(hub *Hub, w http.ResponseWriter, r *http.Request, cc blockchain.ChainCodeInterface) {
